  ...
  return (
    <div className="py-6 w-full">
      ...
      <div className="flex flex-col lg:flex-row w-full items-center lg:items-start lg:gap-10">
        <div className="flex flex-col items-center w-full lg:w-1/2 py-10 lg:py-20">
          <img src={data.imgUrl} alt="author" className="w-48 sm:w-72 lg:w-96 rounded-full" />
          <div className="flex justify-between w-full max-w-md py-8 border-t border-black dark:border-white mt-8 text-lg">
            <p className="font-black">FOLLOW</p>
            <div className="flex gap-4">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:scale-110">
                <FaInstagram />
        ...
        <div className="flex flex-col items-start w-full lg:w-1/2 py-10 lg:py-20 gap-6 px-4 lg:px-0">
          <h3 className="text-3xl sm:text-5xl lg:text-7xl font-black uppercase">{data?.name}</h3>
          <p className="text-base sm:text-lg lg:text-xl font-semibold lg:pr-8">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua...
          </p>
          <p className="text-sm sm:text-base lg:text-lg lg:pr-8">
            Porttitor rhoncus dolor purus non enim praesent elementum. Eget dolor morbi non arcu risus quis varius...
          </p>
        </div>
      </div>
