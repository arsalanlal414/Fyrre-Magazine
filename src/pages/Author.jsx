    ...
    <div className='py-6 w-full'>
        ...
        <div className='flex w-full'>
          <div className="flex flex-col items-center w-1/2 py-20">
            <img src={author1} alt="author image" className='w-96 rounded-full'/>
            <div className="flex justify-between w-96 py-10 border-t border-black mt-10 text-xl">
          ...
          <div className="flex flex-col items-left w-1/2 py-20 justify-center gap-10">
            <h3 className='text-x7xl font-black max-w-96 uppercase'>Louise Jensen</h3>
        ...
        <div className='flex flex-col gap-10 py-10 mt-10 border-t border-black'>
          <h4 className='text-6xl font-black'>Articles by Louise Jensen</h4>
