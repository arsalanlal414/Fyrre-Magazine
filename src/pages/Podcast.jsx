  ...
  return (
    <div className='py-6 w-full'>
      ...
      <div className='flex w-full gap-24 justify-center'>
        <div className="flex flex-col items-center max-w-80 py-20 text-lg">
          <img src={cover1} alt="author image" className='w-80'/>
        ...
        <div className="flex flex-col items-left w-1/2 py-20 justify-center w-full">
          ...
          <h3 className='text-8xl font-black uppercase pb-10'>Save the world from ourselves!</h3>
          ...
          <p className='text-4xl border-t-2 border-b-2 font-black py-12 my-10'>
            The greatest glory in living lies not in never falling, but in rising every time we fall.
            Nelson Mandela
            <p className='text-base pt-4'>Nelson Mandela</p>
          </p>
